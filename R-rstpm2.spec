...
Version  : 1.6.7
Release  : 27
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/rstpm2_1.6.7.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/rstpm2_1.6.7.tar.gz
...
%package dev
Summary: dev components for the R-rstpm2 package.
Group: Development
Requires: R-rstpm2-lib = %{version}-%{release}
Provides: R-rstpm2-devel = %{version}-%{release}
Requires: R-rstpm2 = %{version}-%{release}

%description dev
dev components for the R-rstpm2 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747062160
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/rstpm2/libs/rstpm2.so
/V4/usr/lib64/R/library/rstpm2/libs/rstpm2.so
